...
return [
	...
	*/
	...
	'connections' => [
		...
		'bike_mart_frisco' => [
			'driver' => 'mysql',
			'host' => env('BMF_DB_HOST', '127.0.0.1'),
			'port' => env('BMF_DB_PORT', '3306'),
			'database' => env('BMF_DB_DATABASE', 'forge'),
			'username' => env('BMF_DB_USERNAME', 'forge'),
			'password' => env('BMF_DB_PASSWORD', ''),
			'unix_socket' => env('BMF_DB_SOCKET', ''),
			'charset' => 'utf8mb4',
			'collation' => 'utf8mb4_unicode_ci',
			'prefix' => '',
			'strict' => false,
