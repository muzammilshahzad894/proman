        ...
        <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
            ...
            <div class="d-flex">
                ...
                <div class="flex-grow-1 me-2">
                    <!--begin::Username-->
                    <a href="#" class="text-white text-hover-primary fs-6 fw-semobold">{{ getFullName(user) }}</a>
                    <!--end::Username-->

                    <!--begin::Description-->
                    <span class="text-gray-600 fw-semobold d-block fs-8 mb-1">Python Dev</span>
                    <!--end::Description-->
...
<!--                    </div>-->
                ...
                <div class="me-n2">
                    ...
                    <a
                        ...
                        :class="{'show menu-dropdown' : visible}"
...
#user-menu {
    ...
    inset: 0 auto auto 0;
    margin: 0;
    transform: translate3d(212px, 119px, 0px);
}
</style>
