...
.table.property-calendar th:nth-of-type(7), .table.property-calendar td:nth-of-type(7) {
  color: blue;
}
.table.property-calendar th:nth-of-type(1), .table.property-calendar td:nth-of-type(1) {
  color: red;
}
</style>
@stop