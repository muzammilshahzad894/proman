                            ...
                            <form action="{{ url('admin/sleep') }}/{{$sleep->id}}/edit" method="POST" role="form" enctype="multipart/form-data" class="ajax-submission">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input 
                                            type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control input-half" 
                                            id="title" 
                                            name="title" 
                                            value="{{ old('title', $sleep->title) }}" 
                                        >
                                    </div>
                                    <div class="form-group input-3rd">
                                        ...
                                        <input 
                                            ...
                                            id="display_order" 
                                            name="display_order" 
                                            value="{{ old('display_order', $sleep->display_order) }}" 
