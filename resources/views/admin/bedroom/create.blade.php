            ...
            <div class="col-md-12 col-lg-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{ url('admin/bedroom') }}" method="POST" role="form" enctype="multipart/form-data" class="ajax-submission">
                            @csrf
                            <div class="row">
                            ...
                            <div class="row m-t-20">
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input name="display_order" type="text" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' id="title" value="{{ old('display_order') }}">
                                    </div>
                                </div>
                            </div>
