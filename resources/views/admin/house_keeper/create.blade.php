...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="{{ url('admin/housekeeper') }}" method="POST" role="form" class="ajax-submission">
            @csrf
            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input name="first_name" type="text" class="form-control" id="title" value="{{ old('first_name') }}" autofocus="autofocus">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="title" class="field-required">Last Name</label>
                                                <input name="last_name" type="text" class="form-control" id="title" value="{{ old('last_name') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input name="city" id="cronjob" type="text" class="form-control"
                                            value="{{ old('city') }}" placeholder="examlpe New York">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input name="zip_code" id="minimum_stay" type="text" class="form-control zipcode" value="{{ old('zip_code') }}" placeholder="00000">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input name="phone" type="text" class="form-control phone_us" id="title"
                                            value="{{ old('phone') }}" autofocus="autofocus">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input name="email" type="email" class="form-control" id="title" value="{{ old('email') }}" autofocus="autofocus">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 col-lg-4">
                                    ...
                                    <textarea name="notes" id="inputMessage" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="row m-t-20">
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input name="display_order" type="text" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" id="title" value="{{ old('display_order') }}">
                                    </div>
                                </div>
                            </div>
