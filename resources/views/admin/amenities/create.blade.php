      ...
      <div class="col-lg-12 col-md-12">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <form action="{{ url('admin/amenities') }}" method="POST" class="ajax-submission">
                  @csrf
                  ...
                  <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                    ...
                    <select name="group" class="form-control" id="grouped">
                      <option value=""> - select - </option>
                      <option value="General" @if(@$amenity->group == "General") selected @endif > General </option>
                      <option value="Bedding" @if(@$amenity->group == "Bedding") selected @endif> Bedding </option>
                      <option value="Amenities" @if(@$amenity->group == "Amenities") selected @endif> Amenities</option>
                    </select>
                    @foreach($errors->get('email') as $message)
                    <span class="help-block">{{ $message }}</span>
                    @endforeach
